...
var kinds = {
    ...
    villager: [Types.Entities.VILLAGER, "npc", 0, 0],
    coder: [Types.Entities.CODER, "npc", 0, 0],
    scientist: [Types.Entities.SCIENTIST, "npc", 0, 0],
    priest: [Types.Entities.PRIEST, "npc", 0, 0],
    king: [Types.Entities.KING, "npc", 0, 0],
    rick: [Types.Entities.RICK, "npc", 0, 0],
    nyan: [Types.Entities.NYAN, "npc", 0, 0],
    sorcerer: [Types.Entities.SORCERER, "npc", 0, 0],
    agent: [Types.Entities.AGENT, "npc", 0, 0],
    octocat: [Types.Entities.OCTOCAT, "npc", 0, 0],
    beachnpc: [Types.Entities.BEACHNPC, "npc", 0, 0],
    forestnpc: [Types.Entities.FORESTNPC, "npc", 0, 0],
    desertnpc: [Types.Entities.DESERTNPC, "npc", 0, 0],
    lavanpc: [Types.Entities.LAVANPC, "npc", 0, 0],
