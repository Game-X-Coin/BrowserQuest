...
GXC.generateToken = function(account, tokenName, quantity) {
    return axios.post(process.env.GXC_SERVER + '/v1/oauth/transfer_token', {symbol: tokenName, to: account, quantity: quantity},
...
GXC.consumeToken = function(accessToken, tokenName, quantity) {
    ...
    return axios.post(process.env.GXC_SERVER + '/v1/oauth/transfer_token', {symbol: tokenName, to: FAUCET_ACCOUNT_NAME, quantity: quantity},
